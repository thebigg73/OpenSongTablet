...
public class BBImportFragment extends Fragment {
    ...
    private void selectFile() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            intent.putExtra(DocumentsContract.EXTRA_INITIAL_URI,
                    mainActivityInterface.getStorageAccess().getUriForItem("Settings","",""));
        }
            ...
            if (getContext()!=null) {
                ...
                if (sdCardFile != null) {
                    ...
                    if (newCSV != null) {
                        ...
                        mainActivityInterface.getStorageAccess().writeFileFromString("Settings","","MyBeatBuddyProject.csv",newCSVText.toString(), false);
                    }
                }
            }
    ...
    private void processMyBeatBuddyProject(String content) {
        ...
        if (error) {
            ...
            mainActivityInterface.getStorageAccess().writeFileFromString("Settings","","MyBeatBuddyProject.csv",cachedContent, false);
        }
    }
