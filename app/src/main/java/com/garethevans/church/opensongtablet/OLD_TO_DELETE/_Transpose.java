...
public class _Transpose {
    ...
    void doTranspose(Context c, StorageAccess storageAccess, _Preferences preferences, boolean forcesharps, boolean forceflats, boolean convertchords) {
        ...
        try {
            ...
            if (FullscreenActivity.isPDF || FullscreenActivity.isImage) {
                ...
                _NonOpenSongSQLite nonOpenSongSQLite = nonOpenSongSQLiteHelper.getSong(c,storageAccess,preferences,nonOpenSongSQLiteHelper.getSongId());
    ...
    String transposeThisString(Context c, _Preferences preferences, String direction, String texttotranspose) {
        try {
            // Go through each line and change each chord to $..$
            // This marks the bit to be changed
    ...
    void convertChords(Context c, StorageAccess storageAccess, _Preferences preferences) {
    ...
    private void convertToNumerals(Context c, StorageAccess storageAccess, _Preferences preferences) {
    ...
    private void convertFromNumerals(Context c, StorageAccess storageAccess, _Preferences preferences) {
    ...
    private void transposeChords() {
     ...
     String numberToKey(Context c, _Preferences preferences, String key) {
    ...
    private boolean keyUsesFlats(Context c, _Preferences preferences, String testkey) {
    ...
    void capoTranspose(Context c, _Preferences preferences) {
    ...
    ArrayList<String> quickCapoKey(Context c, _Preferences preferences, String key) {
    ...
    void checkChordFormat(Context c, _Preferences preferences) {
        StaticVariables.transposedLyrics = null;
        StaticVariables.transposedLyrics = "";
        FullscreenActivity.myTransposedLyrics = null;
        FullscreenActivity.myTransposedLyrics = StaticVariables.mLyrics.split("\n");
