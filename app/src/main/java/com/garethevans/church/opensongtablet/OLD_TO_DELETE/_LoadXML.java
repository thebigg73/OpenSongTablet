...
public class _LoadXML extends Activity {
    ...
    static void loadXML(Context c, _Preferences preferences, StorageAccess storageAccess, ProcessSong processSong) throws IOException {
        ...
        if (!filetype.equals("PDF") && !filetype.equals("DOC") && !filetype.equals("IMG") &&
            ...
            if (!isxml) {
                ...
                if (StaticVariables.songfilename.toLowerCase(Locale.ROOT).contains(".onsong")) {
                    ...
                    _OnSongConvert onSongConvert = new _OnSongConvert();
                    _SongXML songXML = new _SongXML();
                    _ChordProConvert chordProConvert = new _ChordProConvert();
                    ...
                    _UsrConvert usrConvert = new _UsrConvert();
                    _SongXML songXML = new _SongXML();
                    _ChordProConvert chordProConvert = new _ChordProConvert();
            ...
            try {
                _NonOpenSongSQLite nonOpenSongSQLite;
                _NonOpenSongSQLiteHelper nonOpenSongSQLiteHelper = new _NonOpenSongSQLiteHelper(c);
    ...
    private static void updateNonOpenSongDetails(_NonOpenSongSQLite nonOpenSongSQLite) {
    ...
    static void prepareLoadCustomReusable(Context c, _Preferences preferences,
    ...
    private static void grabOpenSongXML(Context c, _Preferences preferences, ProcessSong processSong) throws Exception {
    ...
    public static String[] getCCLILogInfo(Context c, _Preferences preferences, String folder, String filename) {
        StorageAccess storageAccess = new StorageAccess();
    ...
    static void getPDFPageCount(Context c, _Preferences preferences, StorageAccess storageAccess) {
    ...
    private static String fixXML(Context c, _Preferences preferences, String section) {
    ...
    static String grabNextSongInSetKey(Context c, _Preferences preferences, StorageAccess storageAccess, String nextsong) {
        String nextkey = "";
