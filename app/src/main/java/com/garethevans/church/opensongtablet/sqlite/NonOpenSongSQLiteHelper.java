...
public class NonOpenSongSQLiteHelper extends SQLiteOpenHelper {
    ...
    public void createBasicSong(Context c, StorageAccess storageAccess, Preferences preferences, String folder, String filename) {
    ...
    public void updateSong(Context c, StorageAccess storageAccess, Preferences preferences, NonOpenSongSQLite sqLite) {
    ...
    public NonOpenSongSQLite getSong(Context c, StorageAccess storageAccess, Preferences preferences, String songid) {
        SQLiteDatabase db = getDB(c,storageAccess,preferences);
        try {
            Cursor cursor = null;
            if (db != null) {
    ...
    public void deleteSong(Context c, StorageAccess storageAccess, Preferences preferences, String songId) {
        try (SQLiteDatabase db = getDB(c,storageAccess,preferences)) {
            if (db!=null) {
