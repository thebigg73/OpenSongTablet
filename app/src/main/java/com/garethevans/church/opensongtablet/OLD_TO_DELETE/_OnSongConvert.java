...
public class _OnSongConvert {
    ...
    public ArrayList<String> convertTextToTags(Context c, StorageAccess storageAccess, _Preferences preferences,
                                               _SongXML songXML, _ChordProConvert chordProConvert, Uri uri, String l) {
    ...
    private String fixRecognisedContent(String l, _ChordProConvert chordProConvert) {
