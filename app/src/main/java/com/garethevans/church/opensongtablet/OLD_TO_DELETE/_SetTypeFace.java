...
*//*
    ...
    public void setUpAppFonts(Context c, _Preferences preferences, Handler lyrichandler, Handler chordhandler, Handler stickyHandler,
    ...
    private FontRequestCallback getFontRequestCallback(final Context c, final _Preferences preferences, final String what,
    ...
    void setChosenFont(final Context c, final _Preferences preferences, String fontnamechosen, String which,
