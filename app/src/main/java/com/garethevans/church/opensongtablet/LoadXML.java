...
public class LoadXML extends Activity {
	...
	public static void loadXML() throws XmlPullParserException, IOException {
		...
		if (!FullscreenActivity.whichSongFolder.contains("Slide") && !FullscreenActivity.whichSongFolder.contains("Scripture")) {
		...
		if (FullscreenActivity.myXML.indexOf("<lyrics")<0) {
