...
/**
 * ZoomAndPan is just like {@link android.widget.ScrollView}, but it supports acting
 * as both a nested scrolling parent and child on both new and old versions of Android.
 * Nested scrolling is enabled by default.
 */
public class ZoomAndPan extends FrameLayout implements NestedScrollingParent3,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(ZoomAndPan v, int scrollX, int scrollY,
    ...
    public ZoomAndPan(@NonNull Context context) {
        this(context, null);
        scaleDetector = new ScaleGestureDetector(context, new ScaleListener());

    }

    public ZoomAndPan(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    protected float getRightFadingEdgeStrength() {
        ...
        final ZoomAndPan.LayoutParams lp = (LayoutParams) child.getLayoutParams();
        final int length = getHorizontalFadingEdgeLength();
    ...
    int getScrollRangeX() {
        ...
        if (getChildCount() > 0) {
            View child = getChildAt(0);
            ZoomAndPan.LayoutParams lp = (LayoutParams) child.getLayoutParams();
            int childSize = child.getWidth() + lp.leftMargin + lp.rightMargin;
            int parentSpace = getWidth() - getPaddingLeft() - getPaddingRight();
    ...
    public boolean pageScroll(int direction) {
        ...
        if (down) {
            ...
            if (count > 0) {
                ...
                ZoomAndPan.LayoutParams lp = (LayoutParams) view.getLayoutParams();
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final ZoomAndPan nsvHost = (ZoomAndPan) host;
