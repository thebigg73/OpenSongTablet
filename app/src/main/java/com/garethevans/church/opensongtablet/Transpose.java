	...
	public static void doTranspose() throws IOException {
		...
		for (int x = 0; x < FullscreenActivity.numrowstowrite; x++) {
			if (FullscreenActivity.myTransposedLyrics[x].indexOf(".") == 0) {
				...
				} else if (oldchordformat.equals("2")) {
					FullscreenActivity.myTransposedLyrics[x] = FullscreenActivity.myTransposedLyrics[x].replace(" A#m", "$.31.$");
					FullscreenActivity.myTransposedLyrics[x] = FullscreenActivity.myTransposedLyrics[x].replace(".A#m", "$.51.$");
					FullscreenActivity.myTransposedLyrics[x] = FullscreenActivity.myTransposedLyrics[x].replace("A#", "$.1.$");
				...
				} else if (oldchordformat.equals("3")) {
				...
				} else if (oldchordformat.equals("4")) {
					//Do all sharps
		...
		if (!FullscreenActivity.mStyle.equals("") && !FullscreenActivity.mStyleIndex.equals("")) {
			myNEWXML += "  <style index=\"" + FullscreenActivity.mStyleIndex + "\">" + FullscreenActivity.mStyle + "</style>\n";			
		} else if (!FullscreenActivity.mStyle.equals("") && FullscreenActivity.mStyleIndex.equals("")){
			myNEWXML += "  <style>" + FullscreenActivity.mStyle + "</style>\n";	
		}
		myNEWXML += "</song>";
...
/*		if (FullscreenActivity.mCapo.equals("1")) {
			// Put the numbers down by one as the capo raises by one!
			// Move num 0 down to -1 (if it goes to 11 it will be moved later)
			// Last step then fixes -1 to be 11
		...
		if (FullscreenActivity.mCapo.equals("2")) {
			// Put the numbers down by two as the capo raises by one!
			// Move num 0 down to -2 and 1 to -1
			// Last step then fixes -1 to be 11 and -2 to be 10
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.0.$", "$.-2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.1.$", "$.-1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.2.$", "$.0.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.3.$", "$.1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.4.$", "$.2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.5.$", "$.3.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.6.$", "$.4.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.7.$", "$.5.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.8.$", "$.6.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.9.$", "$.7.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.10.$", "$.8.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.11.$", "$.9.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-2.$", "$.10.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-1.$", "$.11.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.30.$", "$.28.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.31.$", "$.29.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.32.$", "$.30.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.33.$", "$.31.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.34.$", "$.32.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.35.$", "$.33.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.36.$", "$.34.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.37.$", "$.35.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.38.$", "$.36.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.39.$", "$.37.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.40.$", "$.38.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.41.$", "$.39.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.28.$", "$.40.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.29.$", "$.41.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.50.$", "$.48.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.51.$", "$.49.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.52.$", "$.50.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.53.$", "$.51.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.54.$", "$.52.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.55.$", "$.53.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.56.$", "$.54.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.57.$", "$.55.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.58.$", "$.56.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.59.$", "$.57.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.60.$", "$.58.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.61.$", "$.59.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.48.$", "$.60.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.49.$", "$.61.$");
}

		if (FullscreenActivity.mCapo.equals("3")) {
			// Put the numbers down by three as the capo raises by three!
			// Move num 0 down to -2 and 1 to -1
			// Last step then fixes -1 to be 11 and -2 to be 10
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.0.$", "$.-3.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.1.$", "$.-2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.2.$", "$.-1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.3.$", "$.0.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.4.$", "$.1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.5.$", "$.2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.6.$", "$.3.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.7.$", "$.4.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.8.$", "$.5.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.9.$", "$.6.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.10.$", "$.7.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.11.$", "$.8.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-3.$", "$.9.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-2.$", "$.10.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-1.$", "$.11.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.30.$", "$.27.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.31.$", "$.28.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.32.$", "$.29.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.33.$", "$.30.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.34.$", "$.31.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.35.$", "$.32.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.36.$", "$.33.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.37.$", "$.34.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.38.$", "$.35.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.39.$", "$.36.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.40.$", "$.37.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.41.$", "$.38.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.27.$", "$.39.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.28.$", "$.40.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.29.$", "$.41.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.50.$", "$.47.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.51.$", "$.48.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.52.$", "$.49.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.53.$", "$.50.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.54.$", "$.51.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.55.$", "$.52.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.56.$", "$.53.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.57.$", "$.54.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.58.$", "$.55.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.59.$", "$.56.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.60.$", "$.57.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.61.$", "$.58.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.47.$", "$.59.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.48.$", "$.60.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.49.$", "$.61.$");
}

		if (FullscreenActivity.mCapo.equals("4")) {
			// Put the numbers down by four as the capo raises by four!
			// Move num 0 down to -4 and 1 to -1
			// Last step then fixes -1 to be 11 and -2 to be 10
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.0.$", "$.-4.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.1.$", "$.-3.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.2.$", "$.-2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.3.$", "$.-1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.4.$", "$.0.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.5.$", "$.1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.6.$", "$.2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.7.$", "$.3.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.8.$", "$.4.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.9.$", "$.5.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.10.$", "$.6.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.11.$", "$.7.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-4.$", "$.8.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-3.$", "$.9.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-2.$", "$.10.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-1.$", "$.11.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.30.$", "$.26.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.31.$", "$.27.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.32.$", "$.28.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.33.$", "$.29.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.34.$", "$.30.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.35.$", "$.31.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.36.$", "$.32.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.37.$", "$.33.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.38.$", "$.34.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.39.$", "$.35.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.40.$", "$.36.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.41.$", "$.37.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.26.$", "$.38.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.27.$", "$.39.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.28.$", "$.40.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.29.$", "$.41.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.50.$", "$.46.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.51.$", "$.47.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.52.$", "$.48.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.53.$", "$.49.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.54.$", "$.50.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.55.$", "$.51.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.56.$", "$.52.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.57.$", "$.53.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.58.$", "$.54.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.59.$", "$.55.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.60.$", "$.56.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.61.$", "$.57.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.46.$", "$.58.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.47.$", "$.59.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.48.$", "$.60.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.49.$", "$.61.$");
}

		if (FullscreenActivity.mCapo.equals("5")) {
			// Put the numbers down by five as the capo raises by five!
			// Move num 0 down to -4 and 1 to -1
			// Last step then fixes -1 to be 11 and -2 to be 10
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.0.$", "$.-5.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.1.$", "$.-4.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.2.$", "$.-3.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.3.$", "$.-2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.4.$", "$.-1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.5.$", "$.0.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.6.$", "$.1.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.7.$", "$.2.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.8.$", "$.3.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.9.$", "$.4.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.10.$", "$.5.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.11.$", "$.6.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-5.$", "$.7.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-4.$", "$.8.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-3.$", "$.9.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-2.$", "$.10.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.-1.$", "$.11.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.30.$", "$.25.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.31.$", "$.26.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.32.$", "$.27.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.33.$", "$.28.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.34.$", "$.29.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.35.$", "$.30.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.36.$", "$.31.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.37.$", "$.32.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.38.$", "$.33.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.39.$", "$.34.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.40.$", "$.35.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.41.$", "$.36.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.25.$", "$.37.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.26.$", "$.38.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.27.$", "$.39.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.28.$", "$.40.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.29.$", "$.41.$");

			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.50.$", "$.45.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.51.$", "$.46.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.52.$", "$.47.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.53.$", "$.48.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.54.$", "$.49.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.55.$", "$.50.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.56.$", "$.51.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.57.$", "$.52.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.58.$", "$.53.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.59.$", "$.54.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.60.$", "$.55.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.61.$", "$.56.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.45.$", "$.57.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.46.$", "$.58.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.47.$", "$.59.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.48.$", "$.60.$");
			FullscreenActivity.temptranspChords = FullscreenActivity.temptranspChords.replace("$.49.$", "$.61.$");
