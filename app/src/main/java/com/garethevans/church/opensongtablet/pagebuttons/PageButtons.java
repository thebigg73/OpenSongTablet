...
public class PageButtons {
    ...
    public ArrayList<String> setUpButtonText() {
        ...
        buttonText.add(c.getResources().getString(R.string.song_notes));
        buttonText.add(c.getResources().getString(R.string.select_page));
        buttonText.add(c.getResources().getString(R.string.highlight));
        buttonText.add(c.getResources().getString(R.string.edit));
        buttonText.add(c.getResources().getString(R.string.theme_choose));
        buttonText.add(c.getResources().getString(R.string.autoscale));
        buttonText.add(c.getResources().getString(R.string.font_choose));
        buttonText.add(c.getResources().getString(R.string.profile));
        buttonText.add(c.getResources().getString(R.string.assign_custom_gestures));
        buttonText.add(c.getResources().getString(R.string.pedal));
        buttonText.add(c.getResources().getString(R.string.show_chords));
        buttonText.add(c.getResources().getString(R.string.show_capo));
        buttonText.add(c.getResources().getString(R.string.show_lyrics));
        ...
        buttonText.add(c.getResources().getString(R.string.autoscroll_pause));
