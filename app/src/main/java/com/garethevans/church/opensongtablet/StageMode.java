...
public class StageMode extends AppCompatActivity implements
    ...
    int coltouse = 1;
    boolean longKeyPress = false, shortKeyPress = false;
    ...
    ArrayList<String> filenamesSongsInFolder;
    ...
    public void showFAB(final View fab, boolean show) {
