...
public class _IndexSongs {
    ...
    void fullIndex(Context c, _Preferences preferences, StorageAccess storageAccess,
                   _SQLiteHelper sqLiteHelper, _SongXML songXML,
                   _ChordProConvert chordProConvert, _OnSongConvert onSongConvert,
                   _TextSongConvert textSongConvert, _UsrConvert usrConvert) {
        ...
        try (SQLiteDatabase db = sqLiteHelper.getDB(c)) {
            ...
            String altquery = "SELECT " + _SQLite.COLUMN_FOLDER + ", " + _SQLite.COLUMN_FILENAME +
            ...
            do {
                ...
                if (cursor.getColumnIndex(_SQLite.COLUMN_FOLDER) > -1) {
                    folder = cursor.getString(cursor.getColumnIndex(_SQLite.COLUMN_FOLDER));
                    filename = cursor.getString(cursor.getColumnIndex(_SQLite.COLUMN_FILENAME));
                    ...
                    if (!filename.equals("")) {
                        ...
                        String updateQuery = "UPDATE " + _SQLite.TABLE_NAME + " " + "SET " +
                                _SQLite.COLUMN_FOLDER + "='" + folder.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_FILENAME + "='" + filename.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_TITLE + "='" + title.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_AUTHOR + "='" + author.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_COPYRIGHT + "='" + copyright.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_LYRICS + "='" + lyrics.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_KEY + "='" + key.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_THEME + "='" + theme.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_ALTTHEME + "='" + alttheme.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_AKA + "='" + aka.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_USER1 + "='" + user1.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_USER2 + "='" + user2.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_USER3 + "='" + user3.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_HYMNNUM + "='" + hymnnum.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_CCLI + "='" + ccli.replaceAll("'", "''") + "', " +
                                _SQLite.COLUMN_TIMESIG + "='" + timesig.replaceAll("'", "''") + "' " +
                                "WHERE " + _SQLite.COLUMN_SONGID + "='" + songid + "';";
                        try {
    ...
    private ArrayList<String> tryToFixSong(Context c, StorageAccess storageAccess, _Preferences preferences,
                                           _SongXML songXML, _ChordProConvert chordProConvert,
                                           _OnSongConvert onSongConvert, _UsrConvert usrConvert,
                                           _TextSongConvert textSongConvert, Uri uri) {
