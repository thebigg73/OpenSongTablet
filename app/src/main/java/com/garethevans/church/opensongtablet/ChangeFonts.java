...
public class ChangeFonts extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maxfontslider = (SeekBar) findViewById(R.id.maxfontslider);
        maxfonttext = (TextView) findViewById(R.id.maxfontslidervalue);
    ...
    private class maxfontListener implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            FullscreenActivity.mMaxFontSize = (maxfontslider.getProgress() + 20);
            // Save preferences
            Preferences.savePreferences();
        }
    }
