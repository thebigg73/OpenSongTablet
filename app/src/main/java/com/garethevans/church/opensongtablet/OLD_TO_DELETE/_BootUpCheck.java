...
import com.garethevans.church.opensongtablet.PresenterMode;
import com.garethevans.church.opensongtablet.R;
import com.garethevans.church.opensongtablet.StageMode;
...
public class _BootUpCheck extends AppCompatActivity {
    ...
    private void pulseStartButton() {
        _CustomAnimations ca = new _CustomAnimations();
        ca.pulse(_BootUpCheck.this, goToSongsButton);
    }
    private void pulseStorageButton() {
        _CustomAnimations ca2 = new _CustomAnimations();
    ...
    private void notWriteable() {
        uriTree = null;
        uriTreeHome = null;
        _ShowToast showToast = new _ShowToast();
    ...
    private class GoToSongs extends AsyncTask<Object, String, String> {
        ...
        protected String doInBackground(Object... objects) {
            ...
            if (foldersok) {
                ...
                _SQLiteHelper sqLiteHelper = new _SQLiteHelper(_BootUpCheck.this);
                sqLiteHelper.resetDatabase(_BootUpCheck.this);
                _NonOpenSongSQLiteHelper nonOpenSongSQLiteHelper = new _NonOpenSongSQLiteHelper(_BootUpCheck.this);
