...
public class _ChordProConvert {
    ...
    public ArrayList<String> convertTextToTags(Context c, StorageAccess storageAccess, _Preferences preferences,
                                               _SongXML songXML, Uri uri, String l) {
    ...
    Uri getNewSongUri(Context c, StorageAccess storageAccess, _Preferences preferences, String songSubFolder, String nsf) {
    ...
    void writeTheImprovedSong(Context c, StorageAccess storageAccess, _Preferences preferences,
        ...
        if (oldSongFileName != null && !oldSongFileName.equals("") && newSongFileName != null && !newSongFileName.equals("")
            ...
            _SQLite sqLite = sqLiteHelper.getSong(c,songSubFolder+"/"+newSongFileName);
            if (sqLite!=null) {
