...
import com.garethevans.church.opensongtablet.PopUpSetViewNew;
...
public class _SetListAdapter extends RecyclerView.Adapter<_SetListAdapter.SetItemViewHolder> {

    private final List<_SetItemInfo> setList;
    private final Context c;
    private final _Preferences preferences;

    _SetListAdapter(List<_SetItemInfo> setList, Context context, _Preferences p) {
