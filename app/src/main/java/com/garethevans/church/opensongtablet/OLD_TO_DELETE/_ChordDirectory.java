...
public class _ChordDirectory {

    private static String chordtoworkon;

    private static void simplifyChords(Context c, _Preferences preferences, String tempchord) {
    ...
    static void guitarChords(Context c, _Preferences preferences, String chord) {
    ...
    static void ukuleleChords(Context c, _Preferences preferences, String chord) {
    ...
    static void mandolinChords(Context c, _Preferences preferences, String chord) {
    ...
    static void cavaquinhoChords(Context c, _Preferences preferences, String chord) {
    ...
    static void banjo4stringChords(Context c, _Preferences preferences, String chord) {
    ...
    static void banjo5stringChords(Context c, _Preferences preferences, String chord) {
    ...
    static void pianoChords(Context c, _Preferences preferences, String chord) {
