...
public class Preferences extends Activity {
    ...
    public static void loadPreferences() {
        ...
        // Popup scale, dim and alpha
        FullscreenActivity.popupScale_All = myPreferences.getFloat("popupScale_All", 0.8f);
        FullscreenActivity.popupDim_All = myPreferences.getFloat("popupDim_All", 0.8f);
        FullscreenActivity.popupAlpha_All = myPreferences.getFloat("popupAlpha_All", 0.8f);
        ...
        FullscreenActivity.popupDim_Set = myPreferences.getFloat("popupDim_Set", 0.8f);
        FullscreenActivity.popupAlpha_Set = myPreferences.getFloat("popupAlpha_Set", 0.8f);
    ...
    public static void savePreferences() {
        AsyncTask<Object, Void, String> save_preferences = new SavePreferences();
        try {
            save_preferences.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    private static class SavePreferences extends AsyncTask<Object, Void, String> {
