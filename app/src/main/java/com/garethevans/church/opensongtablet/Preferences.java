...
public class Preferences extends Activity {
    ...
    public static void loadPreferences() {
        ...
        try {
            ...
            FullscreenActivity.customPadAb = myPreferences.getString("customPadAb", null);
            FullscreenActivity.customPadA = myPreferences.getString("customPadA", null);
            FullscreenActivity.customPadBb = myPreferences.getString("customPadBb", null);
            FullscreenActivity.customPadB = myPreferences.getString("customPadB", null);
            FullscreenActivity.customPadC = myPreferences.getString("customPadC", null);
            FullscreenActivity.customPadDb = myPreferences.getString("customPadDb", null);
            FullscreenActivity.customPadD = myPreferences.getString("customPadD", null);
            FullscreenActivity.customPadEb = myPreferences.getString("customPadEb", null);
            FullscreenActivity.customPadE = myPreferences.getString("customPadE", null);
            FullscreenActivity.customPadF = myPreferences.getString("customPadF", null);
            FullscreenActivity.customPadGb = myPreferences.getString("customPadGb", null);
            FullscreenActivity.customPadG = myPreferences.getString("customPadG", null);
            FullscreenActivity.customPadAbm = myPreferences.getString("customPadAbm", null);
            FullscreenActivity.customPadAm = myPreferences.getString("customPadAm", null);
            FullscreenActivity.customPadBbm = myPreferences.getString("customPadBbm", null);
            FullscreenActivity.customPadBm = myPreferences.getString("customPadBm", null);
            FullscreenActivity.customPadCm = myPreferences.getString("customPadCm", null);
            FullscreenActivity.customPadDbm = myPreferences.getString("customPadDbm", null);
            FullscreenActivity.customPadDm = myPreferences.getString("customPadDm", null);
            FullscreenActivity.customPadEbm = myPreferences.getString("customPadEbm", null);
            FullscreenActivity.customPadEm = myPreferences.getString("customPadEm", null);
            FullscreenActivity.customPadFm = myPreferences.getString("customPadFm", null);
            FullscreenActivity.customPadGbm = myPreferences.getString("customPadGbm", null);
            FullscreenActivity.customPadGm = myPreferences.getString("customPadGm", null);
            ...
            FullscreenActivity.multilineCompact = myPreferences.getBoolean("multilineCompact", false);
    ...
    public static void savePreferences() {
        ...
        try {
            ...
            editor.putString("customPadAb", FullscreenActivity.customPadAb);
            editor.putString("customPadA", FullscreenActivity.customPadA);
            editor.putString("customPadBb", FullscreenActivity.customPadBb);
            editor.putString("customPadB", FullscreenActivity.customPadB);
            editor.putString("customPadC", FullscreenActivity.customPadC);
            editor.putString("customPadDb", FullscreenActivity.customPadDb);
            editor.putString("customPadD", FullscreenActivity.customPadD);
            editor.putString("customPadEb", FullscreenActivity.customPadEb);
            editor.putString("customPadE", FullscreenActivity.customPadE);
            editor.putString("customPadF", FullscreenActivity.customPadF);
            editor.putString("customPadGb", FullscreenActivity.customPadGb);
            editor.putString("customPadG", FullscreenActivity.customPadG);
            editor.putString("customPadAbm", FullscreenActivity.customPadAbm);
            editor.putString("customPadAm", FullscreenActivity.customPadAm);
            editor.putString("customPadBbm", FullscreenActivity.customPadBbm);
            editor.putString("customPadBm", FullscreenActivity.customPadBm);
            editor.putString("customPadCm", FullscreenActivity.customPadCm);
            editor.putString("customPadDbm", FullscreenActivity.customPadDbm);
            editor.putString("customPadDm", FullscreenActivity.customPadDm);
            editor.putString("customPadEbm", FullscreenActivity.customPadEbm);
            editor.putString("customPadEm", FullscreenActivity.customPadEm);
            editor.putString("customPadFm", FullscreenActivity.customPadFm);
            editor.putString("customPadGbm", FullscreenActivity.customPadGbm);
            editor.putString("customPadGm", FullscreenActivity.customPadGm);
            ...
            editor.putBoolean("multilineCompact", FullscreenActivity.multilineCompact);
